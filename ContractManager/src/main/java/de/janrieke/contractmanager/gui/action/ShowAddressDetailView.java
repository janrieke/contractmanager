 ...
 */
public class ShowAddressDetailView implements Action {
	...
	public void handleAction(Object context) throws ApplicationException {
		...
		if (context != null && (context instanceof Address))
			...
			try {
				p = (Address) Settings.getDBService().createObject(
						Address.class, null);
		...
		GUI.startView(de.janrieke.contractmanager.gui.view.AddressDetailView.class
				.getName(), p);
	}
