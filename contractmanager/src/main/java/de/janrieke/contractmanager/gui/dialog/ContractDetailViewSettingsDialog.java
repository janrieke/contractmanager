...
public class ContractDetailViewSettingsDialog extends AbstractDialog<Object> {
	...
	protected void paint(Composite parent) throws Exception {
		...
		c.addLabelPair(Settings.i18n().tr("Show 'Fixed Terms' Field"), control.getShowFixedTermsInput());
		...
		buttons.addButton(i18n.tr("Übernehmen"), context -> {
		...
		buttons.addButton(i18n.tr("Abbrechen"), context -> {
